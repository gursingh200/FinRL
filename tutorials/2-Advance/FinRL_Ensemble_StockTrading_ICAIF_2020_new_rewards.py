...
from finrl.meta.env_stock_trading.env_stocktrading_new_rewards import StockTradingEnv
from finrl.agents.stablebaselines3.models_new_rewards import DRLAgent,DRLEnsembleAgent
...
''' ----------------------------- PROCESSING THE DATA ----------------------------- '''
if(args.indicator_level == 1):
    INDICATORS = ['macd',
                'rsi_30',
                'cci_30',
                'dx_30']
# elif(args.indicator_level == 0): # DOES NOT WORK YET, ISSUE WITH THE DIMENSIONS OF THE MODEL
#     INDICATORS = []
