...
class StockTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        if(reward_type not in ["Sharpe","Sortino"] and delta_reward==True):
            print("Using delta rewards here isn't logical, reverting to non delta rewards")
            self.delta_reward = False
    ...
    # def rolling_sterling_ratio(self,cur_return):

    #     # Pretty inefficient way of computing max_drawdown
    ...
    #     peak = self.returns_queue[0]
    #     for price in self.returns_queue:
    #         if price > peak:
    #             peak = price
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            #     if(self.delta_reward == True):
            #         self.reward = self.rolling_sharpe_ratio(end_total_asset-begin_total_asset) - self.prev_metric
            #     else: 
            #         self.reward = self.rolling_sharpe_ratio(end_total_asset-begin_total_asset)

            # elif(self.reward_type == "Sortino"):
            #     if(self.delta_reward == True):
            #         self.reward = self.rolling_downside_deviation_ratio(end_total_asset - begin_total_asset) - self.prev_metric
            #     else:
